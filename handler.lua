...
local function fetchRemoteData(endpointURL)
	local success, response = pcall(function()
		return HttpService:GetAsync(endpointURL, true, {["Authorization"] = "your_api_key"}) -- change this to your own api key
	end)
	if success then
...
while true do
	...
	for _, dataType in ipairs(dataTypes) do
		local dataArray = fetchRemoteData("https://xandersite.xyz/data/" .. dataType) -- change to your own api url
		if dataArray then
